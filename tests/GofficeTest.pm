...
@GofficeTest::ISA = qw (Exporter);
@GofficeTest::EXPORT = qw(message test_valgrind
			 test_zip
			 $topsrc $top_builddir
			 $gsf $PERL);
@GofficeTest::EXPORT_OK = qw(junkfile);
...
&report_skip ("all tests skipped") if exists $ENV{'GOFFICE_SKIP_TESTS'};
